...
from funcaptcha_challenger import predict_3d_rollball_animals, predict_numericalmatch
...
class TestRotateAnimal(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.images_path = os.path.join(this_dir, '../demo', 'captcha-images','3d_rollball_animals')
